...
const features = [
  {
    title: 'Who I Am',
    content:
    '웹과 사용자를 매끄럽게 연결하는 프론트엔드 개발자로서, 사용자의 니즈를 깊이 이해하고 체계적인 리서치를 통해 직관적인 UI 흐름을 설계합니다. 깔끔하고 모듈화된 코드를 작성하여 유지보수성과 확장성을 확보하며, 반응형 레이아웃과 퍼포먼스 최적화를 통해 다양한 디바이스 환경에서도 빠르고 안정적인 경험을 제공합니다. '
  },
